...
class RolePermissionServiceImplTest {
    ...
    void testCanApproveTimesheet_shouldReturnTrueForManager() {
        // Arrange
        when(projectRoleMapper.findByProjectAndUser(1L, 2L)).thenReturn(managerRole);

        // Act
        boolean result = rolePermissionService.canApproveTimesheet(2L, 1L);

        // Assert
        assertTrue(result);
        verify(projectRoleMapper).findByProjectAndUser(1L, 2L);
    }

    @Test
    void testCanApproveTimesheet_shouldReturnTrueForOwner() {
        // Arrange
        when(projectRoleMapper.findByProjectAndUser(1L, 1L)).thenReturn(ownerRole);

        // Act
        boolean result = rolePermissionService.canApproveTimesheet(1L, 1L);
    ...
    void testCanApproveTimesheet_shouldReturnFalseForDeveloper() {
        // Arrange
        when(projectRoleMapper.findByProjectAndUser(1L, 3L)).thenReturn(developerRole);

        // Act
        boolean result = rolePermissionService.canApproveTimesheet(3L, 1L);
    ...
    void testCanApproveTimesheet_shouldReturnFalse_whenNoRoleFound() {
        // Arrange
        when(projectRoleMapper.findByProjectAndUser(1L, 999L)).thenReturn(null);

        // Act
        boolean result = rolePermissionService.canApproveTimesheet(999L, 1L);
    ...
    void testCanManageSprint_shouldReturnTrueForOwner() {
        ...
        // Act
        boolean result = rolePermissionService.canManageSprint(1L, 1L);
    ...
    void testCanManageSprint_shouldReturnTrueForManager() {
        ...
        // Act
        boolean result = rolePermissionService.canManageSprint(2L, 1L);
    ...
    void testCanManageSprint_shouldReturnFalseForDeveloper() {
        ...
        // Act
        boolean result = rolePermissionService.canManageSprint(3L, 1L);
    ...
    void testCanManageSprint_shouldReturnFalseForDevLead() {
        // Arrange
        when(projectRoleMapper.findByProjectAndUser(1L, 4L)).thenReturn(devLeadRole);

        // Act
        boolean result = rolePermissionService.canManageSprint(4L, 1L);
    ...
    void testCanManageSprint_shouldReturnFalse_whenNoRoleFound() {
        ...
        // Act
        boolean result = rolePermissionService.canManageSprint(999L, 1L);
    ...
    void testGetProjectRole_shouldReturnCorrectRole() {
        ...
        // Act
        String role = rolePermissionService.getProjectRole(1L, 1L);
    ...
    void testGetProjectRole_shouldReturnCorrectRoleForManager() {
        ...
        // Act
        String role = rolePermissionService.getProjectRole(2L, 1L);
    ...
    void testGetProjectRole_shouldReturnCorrectRoleForDeveloper() {
        ...
        // Act
        String role = rolePermissionService.getProjectRole(3L, 1L);
    ...
    void testGetProjectRole_shouldReturnNone_whenNoRoleFound() {
        ...
        // Act
        String role = rolePermissionService.getProjectRole(999L, 1L);
    ...
    void testCanManageTasks_shouldReturnTrueForOwner() {
        ...
        // Act
        boolean result = rolePermissionService.canManageTasks(1L, 1L);
    ...
    void testCanManageTasks_shouldReturnTrueForManager() {
        ...
        // Act
        boolean result = rolePermissionService.canManageTasks(2L, 1L);
    ...
    void testCanManageTasks_shouldReturnTrueForDevLead() {
        ...
        // Act
        boolean result = rolePermissionService.canManageTasks(4L, 1L);
    ...
    void testCanManageTasks_shouldReturnFalseForDeveloper() {
        ...
        // Act
        boolean result = rolePermissionService.canManageTasks(3L, 1L);
    ...
    void testCanManageMembers_shouldReturnTrueForOwner() {
        ...
        // Act
        boolean result = rolePermissionService.canManageMembers(1L, 1L);
    ...
    void testCanManageMembers_shouldReturnTrueForManager() {
        ...
        // Act
        boolean result = rolePermissionService.canManageMembers(2L, 1L);
    ...
    void testCanManageMembers_shouldReturnFalseForDevLead() {
        ...
        // Act
        boolean result = rolePermissionService.canManageMembers(4L, 1L);
    ...
    void testCanConfigureProject_shouldReturnTrueForOwner() {
        ...
        // Act
        boolean result = rolePermissionService.canConfigureProject(1L, 1L);
    ...
    void testCanConfigureProject_shouldReturnFalseForManager() {
        ...
        // Act
        boolean result = rolePermissionService.canConfigureProject(2L, 1L);
    ...
    void testCanConfigureProject_shouldReturnFalseForDevLead() {
        ...
        // Act
        boolean result = rolePermissionService.canConfigureProject(4L, 1L);
