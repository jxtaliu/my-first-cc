export default {
  ...
  project: {
    ...
    confirmCompleteMilestone: '确定要完成此里程碑吗？',
    milestoneCompleted: '里程碑已完成',
    completeFailed: '完成里程碑失败',
    confirmDeleteMilestone: '确定要删除此里程碑吗？',
  ...
  dataStandardsRoot: {
    title: '数据标准',
    description: '管理各类数据标准，包括枚举值、编码型、字符型、数值型等',
    searchPlaceholder: '搜索标准名称或编码',
    filterByType: '筛选类型',
    typeAll: '全部',
    typeEnum: '枚举值',
    typeCode: '编码型',
    ...
    addStandard: '新增标准',
    editStandard: '编辑标准',
    codePlaceholder: '如: PRIORITY_TYPE',
    namePlaceholder: '如: 优先级枚举',
    selectType: '请选择类型',
    ownerPlaceholder: '请输入责任人',
    enumItems: '枚举值定义',
    enumValue: '枚举值',
    enumLabel: '显示标签',
    addEnumItem: '添加枚举值',
    sortOrder: '排序',
    codeDefinition: '编码型定义',
    codeFormat: '格式',
    codeFormatPlaceholder: '如: [A-Z0000]',
    codePrefix: '前缀',
    codePrefixPlaceholder: '如: PRJ',
    codeLength: '长度',
    codeExample: '示例',
    codeExamplePlaceholder: '如: PRJ001',
    stringDefinition: '字符型定义',
    minLength: '最小长度',
    maxLength: '最大长度',
    pattern: '正则表达式',
    patternPlaceholder: '如: ^[A-Za-z]+$',
    numberDefinition: '数值型定义',
    minValue: '最小值',
    maxValue: '最大值',
    decimalPlaces: '小数位数',
    example: '示例',
    ...
    webhookUrlPlaceholder: '请输入飞书机器人Webhook地址',
    recipient: '收件人',
    emailPlaceholder: '请输入邮箱地址',
    send: '发送',
    shareSuccess: '分享成功',
    webhookRequired: '请输入Webhook地址',
